...
class DataSetSplitterImpl(DataSetSplitter):
    def split_data_set_into_train_validation_test(self, x_data, y_data, test_data_percentage):
        x_train, x_test, y_train, y_test = train_test_split(x_data, y_data, test_size=test_data_percentage,
                                                            random_state=123)

        preprocessed_data = PreprocessedDataSetInfo(x_train, x_test, y_train, y_test)
