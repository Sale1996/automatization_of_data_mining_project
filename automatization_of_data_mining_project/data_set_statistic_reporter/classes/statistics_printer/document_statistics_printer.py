...
class DocumentStatisticsPrinter(StatisticsPrinter):
    def print_statistics(self, statistics_as_data_set: List[List[str]]):
        ...
        filename = os.path.join(
            "C:/Users/Sale/Desktop/MASTER_PROJEKAT/automatization_of_data_mining_project/automatization_of_data_mining_project/generated_statistics/data_sets_statistics_" + current_time_string + ".csv")
