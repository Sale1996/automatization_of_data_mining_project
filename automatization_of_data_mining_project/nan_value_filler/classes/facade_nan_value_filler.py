...
class FacadeNanValueFiller(NanValueFiller):
    ...
    def fill_nan_values(self, data_set_info, filling_method, filling_column_name):
        ...
        #
        # if filling_method == "fill_with_min":
        ...
        #
        # if filling_method == "fill_with_mean":
        ...
        #
        #     predictor_model = predictor_factory.get_fitted_predictor_by_name(preprocessed_data_set,
        ...
        #         new_row[filling_column_index] = predicted_value[0][0]
