...
class FillWithLogisticRegression(NanFiller):
    def __init__(self):
        super().__init__()
        self.name = "fill_with_logistic_regression"

    def fill_nan_values(self, data_set_info, filling_column_name):
        fill_with_predictor = FillWithPredictor()

        return fill_with_predictor.fill_nan_values(data_set_info, filling_column_name, "Logistic Regression")
